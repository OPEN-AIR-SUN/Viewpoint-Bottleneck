...
This files defines ScannetVoxelizationtestDataset, which is a derived class of VoxelizationDataset.
ScannetVoxelizationtestDataset is used for testing

"""

raise RuntimeError('scannet_test module is not used anymore')
...
class ScannetVoxelizationtestDataset(VoxelizationDataset):
