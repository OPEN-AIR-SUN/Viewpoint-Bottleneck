...
data_arg.add_argument(
    '--scannet_path',
    type=str,
    default='/home/aidrive1/workspace/luoly/dataset/Min_scan/eff_100/train',
    help='Scannet online voxelization dataset root dir')

data_arg.add_argument(
    '--scannet_test_path',
    type=str,
    default='/home/aidrive1/workspace/luoly/dataset/Min_scan/scan_processed/train',
    help='Scannet online voxelization dataset root dir')
...
train_arg.add_argument('--val_freq', type=int, default=2, help='validation frequency')
